...
A `LICENSE-mem0` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [mem0ai/mem0](https://github.com/mem0ai/mem0), Copyright
the mem0ai/mem0 authors, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../mem0-port/specs/SPEC-001-mem0.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
